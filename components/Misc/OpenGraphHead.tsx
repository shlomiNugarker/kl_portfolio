...
// Per-locale share images (generated by scripts/generate-og-image.js) so a
// link shared from /he or /ar previews in the reader's language.
const ogImage: Record<Locale, string> = {
  en: `${SITE_URL}/og-image.png`,
  he: `${SITE_URL}/og-image-he.png`,
  ar: `${SITE_URL}/og-image-ar.png`,
}
...
const OpenGraphHead = () => {
  ...
  const image = ogImage[locale] ?? ogImage[DEFAULT_LOCALE]
